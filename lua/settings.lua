...
-- Defining NyanVimUpdate commands.
vim.api.nvim_create_user_command("NyanVimUpdate", function()
  require("utils").update()
end, { nargs = 0 })

-- NOTE: Set your shell to powershell because of :NyanVimUpdate command and
...
-- Creating NyanVimTransparent command.
vim.api.nvim_create_user_command("NyanVimTransparent", "lua make_nyan_vim_transparent()", { nargs = 0 })
